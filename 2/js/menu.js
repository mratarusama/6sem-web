...
let showInterestsMenu = function (e) {
    let interestsButton = $('.menu_item')[2];
    $('#interestsMenu').css({
        display: 'block',
        height: 'auto',
        top: interestsButton.offsetTop + interestsButton.clientHeight + 4,
        left: interestsButton.offsetLeft - 2,
        width: interestsButton.clientWidth - 1
    }).focus();
}
